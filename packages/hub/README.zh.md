...
| [`hub-storage/`](hub-storage/README.md) | SQLite 控制平面记录；不缓存节点文件 | 无 |
...
| [`hub-connector/`](hub-connector/README.md) | 把现有 DSH Host API 与事件通道接入认证本地 IPC 的 Cordis 插件 | `apiProxy`、Typert Gateway |
| [`hub-client-ui/`](hub-client-ui/README.md) | 装入官方 Web 设置页的节点、插件与高级诊断界面 | `slots`、`locale` |
