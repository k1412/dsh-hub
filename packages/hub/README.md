...
| [`hub-storage/`](hub-storage/README.md) | SQLite control-plane records and content-addressed durable objects | none |
...
| [`hub-connector/`](hub-connector/README.md) | Cordis plugin bridging the existing DSH `apiProxy` into authenticated local IPC | `apiProxy` |
