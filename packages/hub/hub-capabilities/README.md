...
Version 1 covers shared sessions and live events, interactive terminals, plugin inventory and transactional rollout, four snapshot classes, runtime health, redacted settings, and node-authoritative workspace files. Every operation and stream has a strict runtime schema whose canonical JSON Schema hash is included in the advertised capability descriptor.
