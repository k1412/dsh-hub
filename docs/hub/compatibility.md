...
| `0.1.5-rc.2` / `0.1.5-rc.3` | Remote gateway and Session API changes | Connector Remote fallback, event bridge, and `$events/result` answer path covered; bundled Web UI remains the rc.7 composition |
| `0.1.6-alpha.2` / `0.1.7-alpha.1` | current alpha; plugin manager and Session changes | Connector Remote fallback, tool/Skill routing, questions/cancel, event bridge, and `$events/result` answer path covered; bundled Web UI remains the rc.7 composition |
