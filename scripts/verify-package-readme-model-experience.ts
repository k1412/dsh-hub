...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/hub/hub-client-ui': { kind: 'none', reason: 'Browser-side Hub Settings projection; registers nothing model-facing.' },
  ...
  'packages/hub/hub-protocol': { kind: 'none', reason: 'The signed control-plane wire contract registers nothing model-facing.' },
  'packages/hub/hub-storage': { kind: 'none', reason: 'Control-plane persistence registers nothing model-facing.' },
  'packages/hub/hub-transport': { kind: 'none', reason: 'Reliable control-plane delivery registers nothing model-facing.' },
  'packages/hub/hub-server': { kind: 'none', reason: 'The remote control-plane server registers nothing model-facing.' },
  'packages/hub/hub-capabilities': { kind: 'none', reason: 'Node control contracts register nothing model-facing.' },
  'packages/hub/hub-node-ipc': { kind: 'none', reason: 'Local node IPC registers nothing model-facing.' },
  'packages/hub/hub-node-agent': { kind: 'none', reason: 'The supervised node transport registers nothing model-facing.' },
  'packages/hub/hub-connector': { kind: 'none', reason: 'The host-side control bridge registers no model-facing prompt, tool, skill, or context.' },
