window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".u41EIG_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.u41EIG_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:u41EIG_trajectory-table/inline-size}.u41EIG_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.u41EIG_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.u41EIG_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite u41EIG_history-loading-spin}.u41EIG_table tbody .u41EIG_historyLoadRow td{height:30px;padding:0}.u41EIG_table tbody .u41EIG_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.u41EIG_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.u41EIG_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.u41EIG_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.u41EIG_historyLoadButton:disabled{cursor:default}.u41EIG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.u41EIG_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes u41EIG_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.u41EIG_historyLoadingSpinner{animation:none}}.u41EIG_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.u41EIG_eventColumn{width:122px}.u41EIG_contentColumn{width:auto}.u41EIG_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.u41EIG_eventHeader{text-align:right!important;padding-right:4px!important}.u41EIG_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.u41EIG_table tbody .u41EIG_virtualSpacer{pointer-events:none}.u41EIG_table tbody .u41EIG_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.u41EIG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.u41EIG_table tbody tr[data-timeline-focus=outside]{opacity:.24}.u41EIG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.u41EIG_table tbody tr[data-request-only=true]:hover{background:0 0}.u41EIG_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.u41EIG_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.u41EIG_table tbody tr[data-request-only=true] .u41EIG_turnRail{top:-15px;bottom:0}.u41EIG_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.u41EIG_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.u41EIG_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.u41EIG_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.u41EIG_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.u41EIG_requestBoundaryControl:hover:before,.u41EIG_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.u41EIG_requestBoundaryControlActive:before,.u41EIG_requestBoundaryControlActive:hover:before,.u41EIG_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.u41EIG_requestBoundaryControl[data-request-status=error]:before,.u41EIG_requestBoundaryControl[data-request-status=error]:hover:before,.u41EIG_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.u41EIG_requestBoundaryControl:hover:after,.u41EIG_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.u41EIG_requestBoundaryControl:focus-visible{outline:none}.u41EIG_table tbody tr:has(.u41EIG_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.u41EIG_event{position:relative}.u41EIG_turnRail,.u41EIG_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.u41EIG_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.u41EIG_table tbody tr[data-turn-end=true] .u41EIG_turnRail{bottom:0}.u41EIG_selectionRail{z-index:5;width:3px;top:0;bottom:0}.u41EIG_table tbody tr[data-error=true] .u41EIG_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.u41EIG_table tbody tr[data-error=true] .u41EIG_selectionRail{background:var(--dsw-alias-state-error-primary)}.u41EIG_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.u41EIG_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.u41EIG_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.u41EIG_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.u41EIG_turnLabelFull,.u41EIG_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.u41EIG_turnLabelCompact{opacity:0;max-width:0}.u41EIG_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.u41EIG_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.u41EIG_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.u41EIG_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.u41EIG_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.u41EIG_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.u41EIG_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.u41EIG_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.u41EIG_table .u41EIG_kindSlot .u41EIG_message{justify-content:center;width:100%}@container u41EIG_trajectory-table (width<=620px){.u41EIG_eventColumn{width:50px}.u41EIG_event{padding-left:28px!important;padding-right:3px!important}.u41EIG_requestBoundaryControl{--request-boundary-base-left:6px}.u41EIG_kindSlot{width:19px}.u41EIG_kindTag,.u41EIG_table .u41EIG_kindSlot .u41EIG_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.u41EIG_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.u41EIG_kindTagLabel,.u41EIG_turnLabelFull{opacity:0;max-width:0}.u41EIG_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.u41EIG_eventColumn,.u41EIG_event,.u41EIG_requestBoundaryControl,.u41EIG_kindSlot,.u41EIG_kindTag,.u41EIG_kindTagIcon,.u41EIG_kindTagLabel,.u41EIG_turnLabelFull,.u41EIG_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.u41EIG_eventColumn,.u41EIG_kindSlot{transition-property:width}.u41EIG_event{transition-property:padding-right,padding-left}.u41EIG_requestBoundaryControl{transition-property:left}.u41EIG_kindTag{transition-property:padding-right,padding-left}.u41EIG_kindTagIcon{transition-property:width,opacity,transform}.u41EIG_kindTagLabel,.u41EIG_turnLabelFull,.u41EIG_turnLabelCompact{transition-property:max-width,opacity}}.u41EIG_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.u41EIG_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.u41EIG_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.u41EIG_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.u41EIG_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.u41EIG_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.u41EIG_promptDiffSection{min-width:0}.u41EIG_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.u41EIG_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.u41EIG_promptDiff span{min-width:max-content;padding:0 6px;display:block}.u41EIG_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.u41EIG_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.u41EIG_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.u41EIG_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.u41EIG_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.u41EIG_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.u41EIG_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.u41EIG_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.u41EIG_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.u41EIG_table tbody tr[data-collapsed-summary=turn] td,.u41EIG_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.u41EIG_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.u41EIG_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.u41EIG_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.u41EIG_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.u41EIG_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.u41EIG_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.u41EIG_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.u41EIG_resultRequest,.u41EIG_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.u41EIG_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.u41EIG_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.u41EIG_table tbody tr[data-kind=tool] .u41EIG_contentText,.u41EIG_table tbody tr[data-kind=subtool] .u41EIG_contentText,.u41EIG_table tbody tr[data-kind=tool] .u41EIG_resultPreview,.u41EIG_table tbody tr[data-kind=subtool] .u41EIG_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.u41EIG_table tbody tr[data-kind=subtool] .u41EIG_content{padding-left:26px}.u41EIG_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.u41EIG_noOutputText{color:var(--dsw-alias-label-caption)}.u41EIG_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.u41EIG_error,.u41EIG_overview dd.u41EIG_error,.u41EIG_details .u41EIG_errorPayload{color:var(--dsw-alias-state-error-primary)}.u41EIG_details .u41EIG_errorPayload .u41EIG_resultBlockText{color:inherit}.u41EIG_details .u41EIG_jsonPayload.u41EIG_errorPayload,.u41EIG_details .u41EIG_jsonPreview.u41EIG_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.u41EIG_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.u41EIG_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.u41EIG_detailsResizeHandle:focus-visible{outline:none}.u41EIG_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.u41EIG_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.u41EIG_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.u41EIG_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.u41EIG_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.u41EIG_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.u41EIG_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.u41EIG_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.u41EIG_detailTabs::-webkit-scrollbar{display:none}.u41EIG_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.u41EIG_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.u41EIG_detailTabActive{color:var(--dsw-alias-state-business-primary)}.u41EIG_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.u41EIG_close:focus-visible,.u41EIG_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.u41EIG_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.u41EIG_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.u41EIG_detailBodySummary>.u41EIG_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.u41EIG_detailBodySummary>.u41EIG_compactedSummary{flex:1;min-height:0;overflow:auto}.u41EIG_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.u41EIG_summaryScrollRegion:hover,.u41EIG_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.u41EIG_compactedSummary .u41EIG_markdownPayload{padding-right:18px}.u41EIG_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.u41EIG_overviewParentLinks{gap:14px;display:flex}.u41EIG_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.u41EIG_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.u41EIG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.u41EIG_overviewHierarchyNavLink:hover .u41EIG_overviewHierarchyJumpIconTight,.u41EIG_overviewHierarchyNavLink:focus-visible .u41EIG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.u41EIG_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.u41EIG_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.u41EIG_overview>.u41EIG_requestTokenDetail dt{padding-left:12px}.u41EIG_usagePanel{padding:4px 0 10px}.u41EIG_usageGroup+.u41EIG_usageGroup{margin-top:8px}.u41EIG_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.u41EIG_usageGroup .u41EIG_overview{padding:0}.u41EIG_overview dt{color:var(--dsw-alias-label-tertiary)}.u41EIG_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.u41EIG_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.u41EIG_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.u41EIG_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.u41EIG_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.u41EIG_overviewSection+.u41EIG_overviewSection{padding-top:8px}.u41EIG_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.u41EIG_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.u41EIG_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.u41EIG_overviewTitle:hover .u41EIG_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.u41EIG_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.u41EIG_overviewTitle:focus-visible .u41EIG_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.u41EIG_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.u41EIG_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.u41EIG_overviewPreview .u41EIG_jsonPreview>:first-child,.u41EIG_overviewPreview .u41EIG_schemaTree>:first-child{padding-bottom:0}.u41EIG_overviewPreview .u41EIG_schemaTree{margin-bottom:0}.u41EIG_overviewPreview .u41EIG_overview{padding:2px 0 0}.u41EIG_overviewPreview .u41EIG_overview>div{min-height:22px}.u41EIG_markdownPreview,.u41EIG_markdownPayload{color:var(--dsw-alias-label-primary)}.u41EIG_markdownPreview>div,.u41EIG_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.u41EIG_markdownPreview>div h1,.u41EIG_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.u41EIG_markdownPreview>div h2,.u41EIG_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.u41EIG_markdownPreview>div :where(h3,h4,h5,h6),.u41EIG_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.u41EIG_markdownPreview>div :not(pre)>code,.u41EIG_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.u41EIG_markdownPreview>div table,.u41EIG_markdownPayload>div table{font:var(--dsw-font-xs-13)}.u41EIG_markdownPreview>div>:first-child{margin-top:0}.u41EIG_markdownPreview>div>:last-child{margin-bottom:0}.u41EIG_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.u41EIG_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.u41EIG_markdownPreview>div :where(p,ul,ol){margin:8px 0}.u41EIG_markdownPreview>div li:not(:first-child){margin-top:3px}.u41EIG_markdownPreview>div blockquote{margin-top:8px}.u41EIG_markdownPreview>div hr{margin:14px 0}.u41EIG_markdownPreview>div>.md-code-block{margin:10px 0}.u41EIG_assistantContent .u41EIG_markdownPayload,.u41EIG_assistantContent .u41EIG_payload{min-height:0}.u41EIG_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.u41EIG_thinkingQuoteOnlyPreview{margin-bottom:8px}.u41EIG_detailBody>.u41EIG_assistantContentRendered .u41EIG_thinkingQuote{margin-top:14px}.u41EIG_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.u41EIG_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.u41EIG_thinkingToggle[aria-expanded=true] .u41EIG_thinkingChevron{transform:rotate(90deg)}.u41EIG_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.u41EIG_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.u41EIG_thinkingQuote .u41EIG_markdownPreview,.u41EIG_thinkingQuote .u41EIG_markdownPayload,.u41EIG_thinkingQuote .u41EIG_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.u41EIG_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.u41EIG_markdownPreview{padding:6px 14px 8px}.u41EIG_markdownPayload{min-height:100%;padding:14px}.u41EIG_jsonPayload{min-height:100%}.u41EIG_jsonPreview{min-height:0}.u41EIG_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.u41EIG_schemaPreview{min-height:0}.u41EIG_schemaIntro{padding:12px 14px 6px}.u41EIG_schemaPreview .u41EIG_schemaIntro{padding-top:6px}.u41EIG_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.u41EIG_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.u41EIG_schemaParameters{min-width:0}.u41EIG_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.u41EIG_schemaTree{margin:0 6px 8px 0}.u41EIG_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.u41EIG_payloadPreview{min-height:0;padding:6px 14px 8px}.u41EIG_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.u41EIG_sourceBlock+.u41EIG_sourceBlock{margin-top:14px}.u41EIG_sourceBlockHeader,.u41EIG_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.u41EIG_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.u41EIG_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.u41EIG_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.u41EIG_sourceBlockJumpTarget:hover .u41EIG_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.u41EIG_sourceBlockJumpTarget:focus-visible{outline:none}.u41EIG_sourceBlockJumpTarget:focus-visible .u41EIG_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.u41EIG_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.u41EIG_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.u41EIG_panelImageLinkPreview{max-height:140px}.u41EIG_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.u41EIG_panelImageLinkPreview .u41EIG_panelImage{max-height:140px}.u41EIG_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.u41EIG_messageImagesPreview{gap:6px;margin:6px 14px 8px}.u41EIG_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.u41EIG_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.u41EIG_assistantToolCalls li{min-width:0}.u41EIG_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.u41EIG_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.u41EIG_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.u41EIG_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.u41EIG_assistantToolCallButton:hover .u41EIG_assistantToolCallIcon,.u41EIG_assistantToolCallButton:focus-visible .u41EIG_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.u41EIG_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.u41EIG_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.u41EIG_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.u41EIG_systemPrompt{box-sizing:border-box}.u41EIG_toolCatalog{min-height:100%;padding:8px 0 16px}.u41EIG_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.u41EIG_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.u41EIG_toolCatalogSummary::-webkit-details-marker{display:none}.u41EIG_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.u41EIG_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.u41EIG_toolCatalogChevron,.u41EIG_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.u41EIG_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.u41EIG_toolCatalogItem[open] .u41EIG_toolCatalogChevron{transform:rotate(90deg)}.u41EIG_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.u41EIG_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.u41EIG_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.u41EIG_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.u41EIG_toolCatalogTree{margin-left:-14px;margin-right:6px}.u41EIG_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.u41EIG_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.u41EIG_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.u41EIG_overviewPreview .u41EIG_noPayload{padding:6px 14px 8px}.u41EIG_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.u41EIG_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"promptDiff": "u41EIG_promptDiff",
			"panelImageLink": "u41EIG_panelImageLink",
			"schemaDescription": "u41EIG_schemaDescription",
			"toolCatalogDefinition": "u41EIG_toolCatalogDefinition",
			"collapsedTurnContent": "u41EIG_collapsedTurnContent",
			"contextGreen": "u41EIG_contextGreen",
			"markdownPayload": "u41EIG_markdownPayload",
			"sourceBlock": "u41EIG_sourceBlock",
			"overviewSection": "u41EIG_overviewSection",
			"turnLabelFull": "u41EIG_turnLabelFull",
			"toolCallNameTypeface": "u41EIG_toolCallNameTypeface",
			"eventInner": "u41EIG_eventInner",
			"promptDiffLineadded": "u41EIG_promptDiffLineadded",
			"contentText": "u41EIG_contentText",
			"turnRail": "u41EIG_turnRail",
			"assistantOutput": "u41EIG_assistantOutput",
			"toolCallOnly": "u41EIG_toolCallOnly",
			"eventColumn": "u41EIG_eventColumn",
			"promptDiffLinemeta": "u41EIG_promptDiffLinemeta",
			"assistantToolCallButton": "u41EIG_assistantToolCallButton",
			"history-loading-spin": "u41EIG_history-loading-spin",
			"subtoolAmber": "u41EIG_subtoolAmber",
			"sourceBlocks": "u41EIG_sourceBlocks",
			"schema": "u41EIG_schema",
			"messageImages": "u41EIG_messageImages",
			"assistantToolCallsPreview": "u41EIG_assistantToolCallsPreview",
			"systemPrompt": "u41EIG_systemPrompt",
			"overviewHierarchyJumpIconTight": "u41EIG_overviewHierarchyJumpIconTight",
			"resultRequest": "u41EIG_resultRequest",
			"payloadPreview": "u41EIG_payloadPreview",
			"sourceBlockJumpIcon": "u41EIG_sourceBlockJumpIcon",
			"toolCatalogItem": "u41EIG_toolCatalogItem",
			"toolCatalogName": "u41EIG_toolCatalogName",
			"overviewSections": "u41EIG_overviewSections",
			"virtualSpacer": "u41EIG_virtualSpacer",
			"tablePane": "u41EIG_tablePane",
			"kindTagIcon": "u41EIG_kindTagIcon",
			"overview": "u41EIG_overview",
			"event": "u41EIG_event",
			"requestBoundaryControl": "u41EIG_requestBoundaryControl",
			"assistantToolCallArgs": "u41EIG_assistantToolCallArgs",
			"turnLabelCompact": "u41EIG_turnLabelCompact",
			"kindTag": "u41EIG_kindTag",
			"detailTab": "u41EIG_detailTab",
			"visuallyHidden": "u41EIG_visuallyHidden",
			"jsonPayload": "u41EIG_jsonPayload",
			"thinkingQuote": "u41EIG_thinkingQuote",
			"historyLoadingSpinner": "u41EIG_historyLoadingSpinner",
			"historyLoadingBar": "u41EIG_historyLoadingBar",
			"split": "u41EIG_split",
			"inlineResultText": "u41EIG_inlineResultText",
			"turnLabelActive": "u41EIG_turnLabelActive",
			"detailsResizeHandle": "u41EIG_detailsResizeHandle",
			"jsonPreview": "u41EIG_jsonPreview",
			"schemaParameters": "u41EIG_schemaParameters",
			"assistantVioletBright": "u41EIG_assistantVioletBright",
			"collapsedTurnEllipsis": "u41EIG_collapsedTurnEllipsis",
			"overviewTitleIcon": "u41EIG_overviewTitleIcon",
			"schemaIntro": "u41EIG_schemaIntro",
			"requestBoundaryControlActive": "u41EIG_requestBoundaryControlActive",
			"details": "u41EIG_details",
			"toolCatalogChevron": "u41EIG_toolCatalogChevron",
			"toolCatalogIcon": "u41EIG_toolCatalogIcon",
			"inlineResult": "u41EIG_inlineResult",
			"overviewParentLinks": "u41EIG_overviewParentLinks",
			"detailBody": "u41EIG_detailBody",
			"resultBlocks": "u41EIG_resultBlocks",
			"sourceBlockJumpTarget": "u41EIG_sourceBlockJumpTarget",
			"promptDiffLinecontext": "u41EIG_promptDiffLinecontext",
			"resultPreview": "u41EIG_resultPreview",
			"content": "u41EIG_content",
			"assistantContent": "u41EIG_assistantContent",
			"schemaParametersTitle": "u41EIG_schemaParametersTitle",
			"assistantContentRendered": "u41EIG_assistantContentRendered",
			"overviewTitle": "u41EIG_overviewTitle",
			"assistantToolCallName": "u41EIG_assistantToolCallName",
			"kindTagLabel": "u41EIG_kindTagLabel",
			"contentColumn": "u41EIG_contentColumn",
			"historyLoadRow": "u41EIG_historyLoadRow",
			"usageHeading": "u41EIG_usageHeading",
			"error": "u41EIG_error",
			"sourceBlockContent": "u41EIG_sourceBlockContent",
			"detailsHeader": "u41EIG_detailsHeader",
			"overviewHierarchyNavLink": "u41EIG_overviewHierarchyNavLink",
			"selectionRail": "u41EIG_selectionRail",
			"kindSlot": "u41EIG_kindSlot",
			"panelImageLinkPreview": "u41EIG_panelImageLinkPreview",
			"toolCatalogSummary": "u41EIG_toolCatalogSummary",
			"schemaTree": "u41EIG_schemaTree",
			"toolCallPayload": "u41EIG_toolCallPayload",
			"detailsTitle": "u41EIG_detailsTitle",
			"user": "u41EIG_user",
			"overviewPreview": "u41EIG_overviewPreview",
			"thinkingChevron": "u41EIG_thinkingChevron",
			"assistantToolCallText": "u41EIG_assistantToolCallText",
			"arrow": "u41EIG_arrow",
			"summaryScrollRegion": "u41EIG_summaryScrollRegion",
			"table": "u41EIG_table",
			"detailTabs": "u41EIG_detailTabs",
			"markdownPreview": "u41EIG_markdownPreview",
			"systemNeutral": "u41EIG_systemNeutral",
			"promptDiffSection": "u41EIG_promptDiffSection",
			"trajectory-table": "u41EIG_trajectory-table",
			"detailTabActive": "u41EIG_detailTabActive",
			"thinkingToggle": "u41EIG_thinkingToggle",
			"schemaPreview": "u41EIG_schemaPreview",
			"noPayload": "u41EIG_noPayload",
			"toolCatalogTree": "u41EIG_toolCatalogTree",
			"historyLoadButton": "u41EIG_historyLoadButton",
			"promptDiffLineremoved": "u41EIG_promptDiffLineremoved",
			"usageGroup": "u41EIG_usageGroup",
			"promptDiffTitle": "u41EIG_promptDiffTitle",
			"message": "u41EIG_message",
			"errorPayload": "u41EIG_errorPayload",
			"toolAmber": "u41EIG_toolAmber",
			"detailBodySummary": "u41EIG_detailBodySummary",
			"collapsedTurnText": "u41EIG_collapsedTurnText",
			"resultBlocksPreview": "u41EIG_resultBlocksPreview",
			"thinkingQuoteOnlyPreview": "u41EIG_thinkingQuoteOnlyPreview",
			"panelImage": "u41EIG_panelImage",
			"close": "u41EIG_close",
			"schemaName": "u41EIG_schemaName",
			"historyLoading": "u41EIG_historyLoading",
			"detailsLocation": "u41EIG_detailsLocation",
			"messageImagesPreview": "u41EIG_messageImagesPreview",
			"assistantToolCallIcon": "u41EIG_assistantToolCallIcon",
			"toolCatalogDescription": "u41EIG_toolCatalogDescription",
			"usagePanel": "u41EIG_usagePanel",
			"payload": "u41EIG_payload",
			"requestDetailsDot": "u41EIG_requestDetailsDot",
			"timestampToggle": "u41EIG_timestampToggle",
			"turnLabel": "u41EIG_turnLabel",
			"sourceBlockLabel": "u41EIG_sourceBlockLabel",
			"toolCatalogFullDescription": "u41EIG_toolCatalogFullDescription",
			"noOutputText": "u41EIG_noOutputText",
			"compacted": "u41EIG_compacted",
			"eventHeader": "u41EIG_eventHeader",
			"promptDiffSections": "u41EIG_promptDiffSections",
			"requestDetailsName": "u41EIG_requestDetailsName",
			"toolCatalog": "u41EIG_toolCatalog",
			"assistantToolCalls": "u41EIG_assistantToolCalls",
			"compactedSummary": "u41EIG_compactedSummary",
			"requestTokenDetail": "u41EIG_requestTokenDetail",
			"sourceBlockHeader": "u41EIG_sourceBlockHeader",
			"overviewHeading": "u41EIG_overviewHeading",
			"resultBlockText": "u41EIG_resultBlockText"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = "._9dpU1W_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}._9dpU1W_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}._9dpU1W_actions{flex:none;align-items:center;gap:2px;display:flex}._9dpU1W_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}._9dpU1W_toggle:hover,._9dpU1W_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._9dpU1W_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._9dpU1W_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}._9dpU1W_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}._9dpU1W_control[hidden]{display:none}._9dpU1W_control:hover:not(:disabled),._9dpU1W_control[aria-checked=true],._9dpU1W_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}._9dpU1W_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._9dpU1W_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._9dpU1W_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}._9dpU1W_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}._9dpU1W_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}._9dpU1W_controlTrack[data-on=true] ._9dpU1W_controlThumb{transform:translate(10px)}._9dpU1W_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}._9dpU1W_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._9dpU1W_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._9dpU1W_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}._9dpU1W_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}._9dpU1W_search:hover{border-color:var(--dsw-alias-label-caption)}._9dpU1W_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}._9dpU1W_searchIcon{flex:none}._9dpU1W_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}._9dpU1W_searchInput::placeholder{color:var(--dsw-alias-label-caption)}._9dpU1W_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"toggle": "_9dpU1W_toggle",
			"actions": "_9dpU1W_actions",
			"toggleIcon": "_9dpU1W_toggleIcon",
			"root": "_9dpU1W_root",
			"controlTrack": "_9dpU1W_controlTrack",
			"inner": "_9dpU1W_inner",
			"controlThumb": "_9dpU1W_controlThumb",
			"actionIcon": "_9dpU1W_actionIcon",
			"searchInput": "_9dpU1W_searchInput",
			"control": "_9dpU1W_control",
			"search": "_9dpU1W_search",
			"searchIcon": "_9dpU1W_searchIcon",
			"action": "_9dpU1W_action"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".nKdfEG_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.nKdfEG_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.nKdfEG_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.nKdfEG_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.nKdfEG_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.nKdfEG_labels span:first-child{top:7px}.nKdfEG_labels span:nth-child(2){top:21px}.nKdfEG_labels span:nth-child(3){top:35px}.nKdfEG_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.nKdfEG_track[data-panning=true]{cursor:grabbing}.nKdfEG_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.nKdfEG_earlierHistory:hover{opacity:1}.nKdfEG_earlierHistory[aria-disabled=true]{cursor:default}.nKdfEG_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.nKdfEG_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.nKdfEG_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.nKdfEG_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.nKdfEG_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.nKdfEG_lanes[data-animate-viewport=true],.nKdfEG_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.nKdfEG_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.nKdfEG_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.nKdfEG_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.nKdfEG_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.nKdfEG_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.nKdfEG_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.nKdfEG_span[data-timeline-span=tool],.nKdfEG_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.nKdfEG_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.nKdfEG_span[data-equal-duration=true]{width:8px;min-width:8px}.nKdfEG_span[data-selected=false]{opacity:.2}.nKdfEG_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.nKdfEG_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.nKdfEG_span[data-search-match=false]{opacity:.14}.nKdfEG_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.nKdfEG_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.nKdfEG_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.nKdfEG_selectionEdges:before,.nKdfEG_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.nKdfEG_selectionEdges:before{left:0}.nKdfEG_selectionEdges:after{right:0}.nKdfEG_selectionEdges[data-dragging=true]:before,.nKdfEG_selectionEdges[data-dragging=true]:after{width:2px}.nKdfEG_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"empty": "nKdfEG_empty",
			"selection": "nKdfEG_selection",
			"earlierHistory": "nKdfEG_earlierHistory",
			"lanes": "nKdfEG_lanes",
			"turnBoundary": "nKdfEG_turnBoundary",
			"span": "nKdfEG_span",
			"root": "nKdfEG_root",
			"turnBoundaries": "nKdfEG_turnBoundaries",
			"hoverLine": "nKdfEG_hoverLine",
			"plot": "nKdfEG_plot",
			"labels": "nKdfEG_labels",
			"selectionEdges": "nKdfEG_selectionEdges",
			"track": "nKdfEG_track"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".h6H2Ba_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.h6H2Ba_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
