window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".gIjHcq_projectRow,.gIjHcq_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.gIjHcq_projectRow:hover,.gIjHcq_sessionRow:hover,.gIjHcq_sessionRow.gIjHcq_selected{background:var(--dsw-alias-interactive-bg-hover)}.gIjHcq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.gIjHcq_searchResultRow:hover,.gIjHcq_searchResultRow.gIjHcq_selected{background:var(--dsw-alias-interactive-bg-hover)}.gIjHcq_searchResultHeading{align-items:center;min-width:0;display:flex}.gIjHcq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.gIjHcq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.gIjHcq_searchResultWorkspace,.gIjHcq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.gIjHcq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.gIjHcq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.gIjHcq_projectRow{box-sizing:border-box;align-items:center;height:34px}.gIjHcq_projectRow .gIjHcq_rowActions{height:20px}.gIjHcq_sessionRow{height:32px;animation:gIjHcq_row-in .15s var(--ds-ease-in-out);gap:0}.gIjHcq_sessionRow .gIjHcq_title{margin:0 6px 0 4px}.gIjHcq_flatSessionRowWithoutStatus .gIjHcq_title{margin-left:0}@keyframes gIjHcq_row-in{0%{opacity:0}}.gIjHcq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.gIjHcq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.gIjHcq_folderActive{color:var(--dsw-alias-state-business-primary)}.gIjHcq_projectRow .gIjHcq_chevron{display:none}.gIjHcq_projectRow:hover .gIjHcq_chevron{display:inline-flex}.gIjHcq_projectRow:hover .gIjHcq_folder{display:none}.gIjHcq_arrow{transition:transform .15s var(--ds-ease-in-out)}.gIjHcq_arrowOpen{transform:rotate(90deg)}.gIjHcq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.gIjHcq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.gIjHcq_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.gIjHcq_sessionRow .gIjHcq_title{flex:1}.gIjHcq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.gIjHcq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.gIjHcq_dot{flex:none}.gIjHcq_rowActions{flex:none;align-items:center;gap:12px;display:none}.gIjHcq_projectRow:hover .gIjHcq_rowActions,.gIjHcq_sessionRow:hover .gIjHcq_rowActions,.gIjHcq_projectRow.gIjHcq_menuOpen .gIjHcq_rowActions,.gIjHcq_sessionRow.gIjHcq_menuOpen .gIjHcq_rowActions{display:inline-flex}.gIjHcq_sessionRow:hover .gIjHcq_time,.gIjHcq_sessionRow.gIjHcq_menuOpen .gIjHcq_time{display:none}.gIjHcq_projectRow.gIjHcq_menuOpen,.gIjHcq_sessionRow.gIjHcq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.gIjHcq_sessionRow.gIjHcq_dropBefore,.gIjHcq_sessionRow.gIjHcq_dropAfter{position:relative}.gIjHcq_sessionRow.gIjHcq_dropBefore:before,.gIjHcq_sessionRow.gIjHcq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.gIjHcq_sessionRow.gIjHcq_dropBefore:before{top:-7px}.gIjHcq_sessionRow.gIjHcq_dropAfter:after{bottom:-7px}.gIjHcq_hoverContent{flex-direction:column;gap:8px;display:flex}.gIjHcq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.gIjHcq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.gIjHcq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.gIjHcq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.gIjHcq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.gIjHcq_iconButton:hover{color:var(--dsw-alias-label-primary)}.gIjHcq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.gIjHcq_sessionRow,.gIjHcq_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"folderActive": "gIjHcq_folderActive",
			"hoverContent": "gIjHcq_hoverContent",
			"searchResultHeading": "gIjHcq_searchResultHeading",
			"slot": "gIjHcq_slot",
			"projectRow": "gIjHcq_projectRow",
			"visuallyHidden": "gIjHcq_visuallyHidden",
			"dropAfter": "gIjHcq_dropAfter",
			"title": "gIjHcq_title",
			"hoverTitle": "gIjHcq_hoverTitle",
			"chevron": "gIjHcq_chevron",
			"rowActions": "gIjHcq_rowActions",
			"searchResultTitle": "gIjHcq_searchResultTitle",
			"searchResultMeta": "gIjHcq_searchResultMeta",
			"projectText": "gIjHcq_projectText",
			"searchResultSnippet": "gIjHcq_searchResultSnippet",
			"renameInput": "gIjHcq_renameInput",
			"menuOpen": "gIjHcq_menuOpen",
			"arrowOpen": "gIjHcq_arrowOpen",
			"flatSessionRowWithoutStatus": "gIjHcq_flatSessionRowWithoutStatus",
			"arrow": "gIjHcq_arrow",
			"dot": "gIjHcq_dot",
			"searchResultRow": "gIjHcq_searchResultRow",
			"hoverTime": "gIjHcq_hoverTime",
			"selected": "gIjHcq_selected",
			"sessionRow": "gIjHcq_sessionRow",
			"hoverPath": "gIjHcq_hoverPath",
			"dropBefore": "gIjHcq_dropBefore",
			"iconButton": "gIjHcq_iconButton",
			"meta": "gIjHcq_meta",
			"searchResultWorkspace": "gIjHcq_searchResultWorkspace",
			"folder": "gIjHcq_folder",
			"hoverStatus": "gIjHcq_hoverStatus",
			"time": "gIjHcq_time",
			"row-in": "gIjHcq_row-in"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".yGim8G_modalAction{min-width:72px}.yGim8G_modalError,.yGim8G_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.yGim8G_modalError{color:var(--dsw-alias-state-error-primary)}.yGim8G_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "yGim8G_menuStatus",
			"modalAction": "yGim8G_modalAction",
			"modalError": "yGim8G_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = "._32FkZq_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}._32FkZq_root._32FkZq_rail{padding-right:0}._32FkZq_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._32FkZq_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._32FkZq_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}._32FkZq_root:not(._32FkZq_rail) ._32FkZq_sectionHeader{margin-top:2px;margin-right:-4px}._32FkZq_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}._32FkZq_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}._32FkZq_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}._32FkZq_searchSlotExpanded{max-width:100%;padding-left:0}._32FkZq_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}._32FkZq_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}._32FkZq_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}._32FkZq_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}._32FkZq_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._32FkZq_searchExpanded ._32FkZq_searchButton{width:28px;height:30px}._32FkZq_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._32FkZq_searchExpanded ._32FkZq_searchButton:hover{background:0 0}._32FkZq_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}._32FkZq_searchExpanded ._32FkZq_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}._32FkZq_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}._32FkZq_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._32FkZq_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._32FkZq_rail ._32FkZq_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}._32FkZq_rail ._32FkZq_headerActions{max-width:none}._32FkZq_rail ._32FkZq_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}._32FkZq_rail ._32FkZq_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}._32FkZq_rail ._32FkZq_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}._32FkZq_rail ._32FkZq_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._32FkZq_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}._32FkZq_rail ._32FkZq_listArea{margin-left:0;margin-right:0;padding-left:0}._32FkZq_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}._32FkZq_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}._32FkZq_wide{animation:_32FkZq_wide-in .2s var(--ds-ease-in-out)}@keyframes _32FkZq_wide-in{0%{opacity:0}}._32FkZq_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}._32FkZq_flatList>*+*,._32FkZq_searchTree>[role=treeitem]+[role=treeitem],._32FkZq_groupSection>*+*{margin-top:2px}._32FkZq_searchStatus,._32FkZq_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}._32FkZq_searchWarning{color:var(--dsw-alias-label-secondary)}._32FkZq_groupSection{position:relative}._32FkZq_groupSection+._32FkZq_groupSection{margin-top:4px}._32FkZq_listTopDropIndicator,._32FkZq_workspaceDropBefore:before,._32FkZq_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}._32FkZq_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}._32FkZq_listTopDropActive>._32FkZq_workspaceDropBefore:first-child:before{display:none}._32FkZq_workspaceDropBefore:before{top:-8px}._32FkZq_workspaceDropAfter:after{bottom:-8px}._32FkZq_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}._32FkZq_groupSection>._32FkZq_sessionOverflowButton{margin-top:0}._32FkZq_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}._32FkZq_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}._32FkZq_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}._32FkZq_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}._32FkZq_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}._32FkZq_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}._32FkZq_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){._32FkZq_wide{animation:none}._32FkZq_search,._32FkZq_sectionLabel,._32FkZq_searchSlot,._32FkZq_searchInput,._32FkZq_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"wide-in": "_32FkZq_wide-in",
			"searchSlot": "_32FkZq_searchSlot",
			"sectionLabelHidden": "_32FkZq_sectionLabelHidden",
			"listTopDropActive": "_32FkZq_listTopDropActive",
			"searchSlotExpanded": "_32FkZq_searchSlotExpanded",
			"searchButton": "_32FkZq_searchButton",
			"list": "_32FkZq_list",
			"workspaceDropBefore": "_32FkZq_workspaceDropBefore",
			"fade": "_32FkZq_fade",
			"flatList": "_32FkZq_flatList",
			"searchInput": "_32FkZq_searchInput",
			"sectionHeader": "_32FkZq_sectionHeader",
			"listArea": "_32FkZq_listArea",
			"treeBody": "_32FkZq_treeBody",
			"groupSection": "_32FkZq_groupSection",
			"renameInput": "_32FkZq_renameInput",
			"workspaceDropAfter": "_32FkZq_workspaceDropAfter",
			"renameError": "_32FkZq_renameError",
			"listTopDropIndicator": "_32FkZq_listTopDropIndicator",
			"empty": "_32FkZq_empty",
			"search": "_32FkZq_search",
			"searchStatus": "_32FkZq_searchStatus",
			"searchExpanded": "_32FkZq_searchExpanded",
			"clearButton": "_32FkZq_clearButton",
			"searchWarning": "_32FkZq_searchWarning",
			"headerActionsHidden": "_32FkZq_headerActionsHidden",
			"deleteStatus": "_32FkZq_deleteStatus",
			"sectionLabel": "_32FkZq_sectionLabel",
			"iconButton": "_32FkZq_iconButton",
			"headerActions": "_32FkZq_headerActions",
			"sessionOverflowButton": "_32FkZq_sessionOverflowButton",
			"deleteAction": "_32FkZq_deleteAction",
			"rail": "_32FkZq_rail",
			"searchTree": "_32FkZq_searchTree",
			"root": "_32FkZq_root",
			"wide": "_32FkZq_wide"
		};
		//#endregion
