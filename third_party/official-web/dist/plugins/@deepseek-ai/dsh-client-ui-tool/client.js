window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".vPOVCG_root{flex-direction:column;display:flex}.vPOVCG_row{position:relative;overflow:hidden}.vPOVCG_root[data-state=running] .vPOVCG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite vPOVCG_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes vPOVCG_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.vPOVCG_leading{flex-shrink:0}.vPOVCG_root[data-tool^=cordis_] .vPOVCG_leading,.vPOVCG_root[data-tool^=cordis_] .vPOVCG_title{color:var(--dsw-alias-state-business-primary)}.vPOVCG_root[data-tool^=cordis_] .vPOVCG_title{font-weight:500}.vPOVCG_root[data-tool^=cordis_] .vPOVCG_sep{background:var(--dsw-alias-state-business-primary)}.vPOVCG_chevron{color:var(--dsw-alias-label-secondary)}.vPOVCG_title{font-weight:400}.vPOVCG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.vPOVCG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.vPOVCG_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.vPOVCG_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.vPOVCG_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.vPOVCG_errorSummary{color:var(--dsw-alias-state-error-primary)}.vPOVCG_bodyWrap{flex-direction:column;display:flex}.vPOVCG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.vPOVCG_root:hover .vPOVCG_inspectButton,.vPOVCG_inspectButton:focus-visible{opacity:1}.vPOVCG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.vPOVCG_bodyScroll{max-height:260px;overflow-y:auto}.vPOVCG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.vPOVCG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.vPOVCG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.vPOVCG_ioSection::-webkit-scrollbar-track{margin:6px 0}.vPOVCG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.vPOVCG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.vPOVCG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.vPOVCG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.vPOVCG_codeBody,.vPOVCG_terminalBody,.vPOVCG_diffBody,.vPOVCG_readBody,.vPOVCG_searchBody,.vPOVCG_webBody{margin:4px 0 4px 4px}.vPOVCG_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.vPOVCG_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.vPOVCG_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.vPOVCG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"errorSummary": "vPOVCG_errorSummary",
			"bodyScroll": "vPOVCG_bodyScroll",
			"chevron": "vPOVCG_chevron",
			"ioDivider": "vPOVCG_ioDivider",
			"ioText": "vPOVCG_ioText",
			"terminalBody": "vPOVCG_terminalBody",
			"sep": "vPOVCG_sep",
			"ioCard": "vPOVCG_ioCard",
			"diffBody": "vPOVCG_diffBody",
			"dsh-tool-row-sweep": "vPOVCG_dsh-tool-row-sweep",
			"webBody": "vPOVCG_webBody",
			"searchRecovery": "vPOVCG_searchRecovery",
			"visuallyHidden": "vPOVCG_visuallyHidden",
			"searchBody": "vPOVCG_searchBody",
			"root": "vPOVCG_root",
			"leading": "vPOVCG_leading",
			"summarySuffix": "vPOVCG_summarySuffix",
			"fileLink": "vPOVCG_fileLink",
			"ioSection": "vPOVCG_ioSection",
			"title": "vPOVCG_title",
			"row": "vPOVCG_row",
			"inspectButton": "vPOVCG_inspectButton",
			"ioLabel": "vPOVCG_ioLabel",
			"codeBody": "vPOVCG_codeBody",
			"readBody": "vPOVCG_readBody",
			"bodyWrap": "vPOVCG_bodyWrap",
			"summary": "vPOVCG_summary"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".ouvcnG_callRow{border-radius:6px}.ouvcnG_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"subCalls": "ouvcnG_subCalls",
			"callRow": "ouvcnG_callRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".ll_gna_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.ll_gna_cardBody{margin:0}.ll_gna_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.ll_gna_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.ll_gna_code[data-error]{color:var(--dsw-alias-state-error-primary)}.ll_gna_read,.ll_gna_web{margin:0}.ll_gna_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"recovery": "ll_gna_recovery",
			"description": "ll_gna_description",
			"code": "ll_gna_code",
			"cardBody": "ll_gna_cardBody",
			"read": "ll_gna_read",
			"web": "ll_gna_web",
			"empty": "ll_gna_empty"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".Z2SylW_card{flex-direction:column;display:flex}.Z2SylW_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.Z2SylW_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.Z2SylW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.Z2SylW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.Z2SylW_ioSection::-webkit-scrollbar-track{margin:6px 0}.Z2SylW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.Z2SylW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.Z2SylW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.Z2SylW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.Z2SylW_root[data-expandable]{cursor:pointer}.Z2SylW_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.Z2SylW_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite Z2SylW_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes Z2SylW_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.Z2SylW_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.Z2SylW_chevron{color:var(--dsw-alias-label-secondary)}.Z2SylW_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.Z2SylW_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.Z2SylW_root:hover .Z2SylW_iconIdle{opacity:0}.Z2SylW_root:hover .Z2SylW_chevronHover{opacity:1}.Z2SylW_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.Z2SylW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Z2SylW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.Z2SylW_errorSummary{color:var(--dsw-alias-state-error-primary)}.Z2SylW_bodyWrap{flex-direction:column;display:flex}.Z2SylW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.Z2SylW_card:hover .Z2SylW_inspectButton,.Z2SylW_inspectButton:focus-visible{opacity:1}.Z2SylW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.Z2SylW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"inspectButton": "Z2SylW_inspectButton",
			"bodyWrap": "Z2SylW_bodyWrap",
			"leading": "Z2SylW_leading",
			"errorSummary": "Z2SylW_errorSummary",
			"ioDivider": "Z2SylW_ioDivider",
			"chevron": "Z2SylW_chevron",
			"iconIdle": "Z2SylW_iconIdle",
			"terminal": "Z2SylW_terminal",
			"card": "Z2SylW_card",
			"ioLabel": "Z2SylW_ioLabel",
			"dsh-bash-row-sweep": "Z2SylW_dsh-bash-row-sweep",
			"visuallyHidden": "Z2SylW_visuallyHidden",
			"root": "Z2SylW_root",
			"title": "Z2SylW_title",
			"ioSection": "Z2SylW_ioSection",
			"sep": "Z2SylW_sep",
			"summary": "Z2SylW_summary",
			"ioCard": "Z2SylW_ioCard",
			"chevronHover": "Z2SylW_chevronHover",
			"ioText": "Z2SylW_ioText"
		};
		//#endregion
