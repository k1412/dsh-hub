window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".f5vaqW_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.f5vaqW_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.f5vaqW_card,.f5vaqW_card *{box-sizing:border-box}.f5vaqW_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.f5vaqW_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.f5vaqW_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.f5vaqW_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.f5vaqW_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.f5vaqW_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.f5vaqW_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.f5vaqW_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.f5vaqW_card{border-radius:16px}.f5vaqW_body{padding:10px 12px 4px}.f5vaqW_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"dot": "f5vaqW_dot",
			"frame": "f5vaqW_frame",
			"actions": "f5vaqW_actions",
			"discuss": "f5vaqW_discuss",
			"feedback": "f5vaqW_feedback",
			"strip": "f5vaqW_strip",
			"body": "f5vaqW_body",
			"card": "f5vaqW_card",
			"footer": "f5vaqW_footer"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".v80Nla_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.v80Nla_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.v80Nla_card,.v80Nla_card *{box-sizing:border-box}.v80Nla_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.v80Nla_headingBlock{min-width:0}.v80Nla_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.v80Nla_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.v80Nla_detail{margin:0 2px 8px}.v80Nla_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.v80Nla_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.v80Nla_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.v80Nla_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.v80Nla_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.v80Nla_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.v80Nla_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.v80Nla_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.v80Nla_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.v80Nla_option:hover:not(:disabled),.v80Nla_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.v80Nla_optionSelected{border-color:var(--dsw-alias-border-l2)}.v80Nla_option:disabled{cursor:default}.v80Nla_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.v80Nla_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.v80Nla_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.v80Nla_checkbox>svg{grid-area:1/1}.v80Nla_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.v80Nla_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.v80Nla_optionCopy{flex:1;min-width:0}.v80Nla_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.v80Nla_optionLabel{font-size:14px;font-weight:500;line-height:24px}.v80Nla_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.v80Nla_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.v80Nla_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.v80Nla_customRow:hover,.v80Nla_customRow:focus-within,.v80Nla_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.v80Nla_customRow:focus-within,.v80Nla_customRowActive{border-color:var(--dsw-alias-border-l2)}.v80Nla_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.v80Nla_customInput::placeholder{color:var(--dsw-alias-label-caption)}.v80Nla_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.v80Nla_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.v80Nla_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.v80Nla_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.v80Nla_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.v80Nla_card{border-radius:16px}.v80Nla_header{padding:10px 12px 0 18px}.v80Nla_options{padding:4px 8px}.v80Nla_title{font-size:15px;line-height:21px}.v80Nla_option,.v80Nla_customRow{padding:8px 6px}.v80Nla_footer{align-items:flex-end;padding:0 10px}.v80Nla_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.v80Nla_option,.v80Nla_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"option": "v80Nla_option",
			"body": "v80Nla_body",
			"detail": "v80Nla_detail",
			"pager": "v80Nla_pager",
			"customTextarea": "v80Nla_customTextarea",
			"checkboxChecked": "v80Nla_checkboxChecked",
			"description": "v80Nla_description",
			"footer": "v80Nla_footer",
			"card": "v80Nla_card",
			"checkbox": "v80Nla_checkbox",
			"footerActions": "v80Nla_footerActions",
			"feedback": "v80Nla_feedback",
			"optionLabel": "v80Nla_optionLabel",
			"frame": "v80Nla_frame",
			"number": "v80Nla_number",
			"eyebrow": "v80Nla_eyebrow",
			"optionLine": "v80Nla_optionLine",
			"title": "v80Nla_title",
			"iconButton": "v80Nla_iconButton",
			"customRow": "v80Nla_customRow",
			"customInput": "v80Nla_customInput",
			"optionSelected": "v80Nla_optionSelected",
			"options": "v80Nla_options",
			"progress": "v80Nla_progress",
			"optionCopy": "v80Nla_optionCopy",
			"customRowActive": "v80Nla_customRowActive",
			"header": "v80Nla_header",
			"headingBlock": "v80Nla_headingBlock",
			"badge": "v80Nla_badge"
		};
		//#endregion
