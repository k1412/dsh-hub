window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = ".qs9oFG_root{position:relative}.qs9oFG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.qs9oFG_count{margin:0 5px}.qs9oFG_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.qs9oFG_trigger:hover,.qs9oFG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.qs9oFG_trigger svg{transition:transform .12s}.qs9oFG_triggerOpen{transform:rotate(180deg)}.qs9oFG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.qs9oFG_node{min-width:0;position:relative}.qs9oFG_menu>.qs9oFG_node{margin-left:-3px}.qs9oFG_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.qs9oFG_row:hover>.qs9oFG_clickarea,.qs9oFG_row:focus-visible>.qs9oFG_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.qs9oFG_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.qs9oFG_row>[data-state],.qs9oFG_clickarea>[data-state]{margin-top:4px}.qs9oFG_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.qs9oFG_disabled:hover{background:0 0}.qs9oFG_loadingRow{cursor:default}.qs9oFG_disclosure,.qs9oFG_disclosureSpace{flex:none;width:14px;height:18px}.qs9oFG_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.qs9oFG_disclosure:hover{color:var(--dsw-alias-label-primary)}.qs9oFG_disclosureOpen{transform:rotate(90deg)}.qs9oFG_content{flex-direction:column;flex:1;min-width:0;display:flex}.qs9oFG_label,.qs9oFG_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.qs9oFG_label{color:inherit;font-weight:400}.qs9oFG_summary,.qs9oFG_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.qs9oFG_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.qs9oFG_metricToken{grid-row:1;line-height:18px}.qs9oFG_metricDuration{grid-row:2}.qs9oFG_children{margin-left:18px;padding-left:4px;position:relative}.qs9oFG_children:before,.qs9oFG_children>.qs9oFG_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.qs9oFG_children:before{height:26px;top:-26px}.qs9oFG_children[aria-busy=true]:before{content:none}.qs9oFG_children>.qs9oFG_node:before{top:0;bottom:0;left:-4px}.qs9oFG_children>.qs9oFG_node:last-child:before{height:17px;bottom:auto}.qs9oFG_children>.qs9oFG_node>.qs9oFG_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.qs9oFG_notice,.qs9oFG_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.qs9oFG_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.qs9oFG_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.qs9oFG_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"refresh": "qs9oFG_refresh",
			"menu": "qs9oFG_menu",
			"disabled": "qs9oFG_disabled",
			"disclosureSpace": "qs9oFG_disclosureSpace",
			"activitySlot": "qs9oFG_activitySlot",
			"trigger": "qs9oFG_trigger",
			"content": "qs9oFG_content",
			"loadingRow": "qs9oFG_loadingRow",
			"disclosureOpen": "qs9oFG_disclosureOpen",
			"children": "qs9oFG_children",
			"error": "qs9oFG_error",
			"metricToken": "qs9oFG_metricToken",
			"metrics": "qs9oFG_metrics",
			"metricDuration": "qs9oFG_metricDuration",
			"node": "qs9oFG_node",
			"summary": "qs9oFG_summary",
			"triggerOpen": "qs9oFG_triggerOpen",
			"root": "qs9oFG_root",
			"label": "qs9oFG_label",
			"clickarea": "qs9oFG_clickarea",
			"notice": "qs9oFG_notice",
			"row": "qs9oFG_row",
			"count": "qs9oFG_count",
			"disclosure": "qs9oFG_disclosure"
		};
		//#endregion
		...
		*/
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "_4qvhhG_frame" };
		//#endregion
