window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".InKAAG_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.InKAAG_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.InKAAG_frame{transition:none}}.InKAAG_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.InKAAG_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.InKAAG_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.InKAAG_frame[data-details-collapsed] .InKAAG_detailsCol{border-left:none}.InKAAG_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.InKAAG_frame[data-dragging] .InKAAG_handle{transition:none}@media (prefers-reduced-motion:reduce){.InKAAG_handle{transition:none}}.InKAAG_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.InKAAG_detailsCol:hover~.InKAAG_handle[data-side=details]:after,.InKAAG_handle[data-side=details]:hover:after,.InKAAG_handle[data-side=details][data-dragging=true]:after{opacity:1}.InKAAG_handle[data-side=details]:hover:after,.InKAAG_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.InKAAG_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.InKAAG_overlayLayer>*{pointer-events:auto}@media (width<=640px){.InKAAG_mobileSidebarMask{z-index:9;background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.InKAAG_frame[data-mobile-sidebar-open] .InKAAG_sidebarCol{z-index:10;border-right-color:var(--dsw-alias-border-l2);width:min(280px,100vw - 32px);box-shadow:var(--dsw-shadow-lv3);position:absolute;inset:0 auto 0 0}}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "InKAAG_centerCol",
			"detailsCol": "InKAAG_detailsCol",
			"handle": "InKAAG_handle",
			"overlayLayer": "InKAAG_overlayLayer",
			"mobileSidebarMask": "InKAAG_mobileSidebarMask",
			"frame": "InKAAG_frame",
			"sidebarCol": "InKAAG_sidebarCol"
		};
		//#endregion
		...
		*/
		...
		function AppFrame({ useStore, useSessions, actions, renderSlot }) {
			...
			const frameSidebar = mobile ? 56 : cols.sidebar;
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				style: { gridTemplateColumns: `${frameSidebar}px minmax(0, 1fr) ${cols.details}px` },
				"data-sidebar-collapsed": sidebarCollapsed || void 0,
				"data-mobile-sidebar-open": mobile && !sidebarCollapsed || void 0,
				"data-details-collapsed": cols.details === 0 || void 0,
				"data-dragging": dragging || void 0,
				children: [
					mobile && !sidebarCollapsed && (0, react_jsx_runtime.jsx)("div", {
						className: AppFrame_module_css_default.mobileSidebarMask,
						"aria-hidden": "true",
						onClick: () => {
