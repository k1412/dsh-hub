window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".oOz8Pa_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.oOz8Pa_field+.oOz8Pa_field{border-top:1px solid var(--dsw-alias-border-l2)}.oOz8Pa_head{align-items:center;gap:8px;display:flex}.oOz8Pa_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.oOz8Pa_badges{align-items:center;gap:8px;display:inline-flex}.oOz8Pa_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.oOz8Pa_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.oOz8Pa_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.oOz8Pa_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.oOz8Pa_reset:disabled{cursor:default}.oOz8Pa_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.oOz8Pa_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.oOz8Pa_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.oOz8Pa_inputInvalid{border-color:var(--dsw-alias-label-error);}.oOz8Pa_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.oOz8Pa_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			...
			"label": "oOz8Pa_label",
			"field": "oOz8Pa_field",
			"invalid": "oOz8Pa_invalid",
			"head": "oOz8Pa_head",
			"inputInvalid": "oOz8Pa_inputInvalid",
			"badges": "oOz8Pa_badges",
			"badge": "oOz8Pa_badge",
			"hint": "oOz8Pa_hint",
			"badgeMuted": "oOz8Pa_badgeMuted",
			"input": "oOz8Pa_input"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".T73tBa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.T73tBa_card:hover{border-color:var(--dsw-alias-label-dimmed)}.T73tBa_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.T73tBa_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.T73tBa_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.T73tBa_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.T73tBa_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.T73tBa_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.T73tBa_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.T73tBa_chevronOpen{transform:rotate(180deg)}.T73tBa_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.T73tBa_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.T73tBa_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.T73tBa_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.T73tBa_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.T73tBa_discard,.T73tBa_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.T73tBa_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.T73tBa_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.T73tBa_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.T73tBa_discard:disabled,.T73tBa_save:disabled{opacity:.4;cursor:default}.T73tBa_discard:focus-visible,.T73tBa_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"headText": "T73tBa_headText",
			"description": "T73tBa_description",
			"save": "T73tBa_save",
			"cardOpen": "T73tBa_cardOpen",
			"name": "T73tBa_name",
			"discard": "T73tBa_discard",
			"card": "T73tBa_card",
			"failed": "T73tBa_failed",
			"readOnly": "T73tBa_readOnly",
			"pending": "T73tBa_pending",
			"chevronOpen": "T73tBa_chevronOpen",
			"body": "T73tBa_body",
			"footer": "T73tBa_footer",
			"header": "T73tBa_header",
			"chevron": "T73tBa_chevron"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = "._7EiknG_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}._7EiknG_heading{margin:0;font-size:18px;font-weight:600}._7EiknG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}._7EiknG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}._7EiknG_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}._7EiknG_tab:hover,._7EiknG_tab[data-active=true]{color:var(--dsw-alias-label-primary)}._7EiknG_tab[data-active=true]:after,._7EiknG_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}._7EiknG_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}._7EiknG_panel{min-width:0;padding-top:2px}._7EiknG_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}._7EiknG_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			...
			"panel": "_7EiknG_panel",
			"empty": "_7EiknG_empty",
			"section": "_7EiknG_section",
			"heading": "_7EiknG_heading"
		};
		//#endregion
