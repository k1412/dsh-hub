		...
		*/
		...
		const CLIENT_SLOT_API = [
			...
			},
			{
				...
				slotInject: "",
				declaredBy: "an entry in 'conversation' (client-ui-conversation), so it exists while that entry is mounted",
				occupants: ["@k1412/dsh-hub-client-ui HubRuntimePicker"],
				replaceRisk: "shadows-shipped-ui",
			...
			},
			{
				...
				occupants: ["client-ui-settings-general SettingsDocumentAction id 'open-document'", "@k1412/dsh-hub-client-ui HubSettingsTarget id 'hub-runtime-target'"],
				replaceRisk: "none",
			...
			},
			{
				...
				occupants: [
					...
					"@k1412/dsh-hub-client-ui HubNodesSection id 'hub-nodes'",
					"@k1412/dsh-hub-client-ui HubPluginsSection id 'hub-plugins'"
				],
				replaceRisk: "none",
