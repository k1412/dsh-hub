window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".W2ii3q_card{flex-direction:column;gap:8px;display:flex}.W2ii3q_row{align-items:center;min-height:32px;display:flex}.W2ii3q_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.W2ii3q_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.W2ii3q_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.W2ii3q_summary,.W2ii3q_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.W2ii3q_error{color:var(--dsw-alias-state-error-primary)}.W2ii3q_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.W2ii3q_card[data-cordis-status=awaiting-approval] .W2ii3q_status,.W2ii3q_card[data-cordis-status=client-pending] .W2ii3q_status{color:var(--dsw-alias-state-warn-label)}.W2ii3q_card[data-cordis-status=running] .W2ii3q_status{color:var(--dsw-alias-state-success-primary)}.W2ii3q_card[data-cordis-status=failed] .W2ii3q_status{color:var(--dsw-alias-state-error-primary)}.W2ii3q_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.W2ii3q_card:hover .W2ii3q_inspect,.W2ii3q_inspect:focus-visible{opacity:1}.W2ii3q_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.W2ii3q_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.W2ii3q_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.W2ii3q_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.W2ii3q_business .W2ii3q_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"separator": "W2ii3q_separator",
			"card": "W2ii3q_card",
			"error": "W2ii3q_error",
			"inspect": "W2ii3q_inspect",
			"row": "W2ii3q_row",
			"business": "W2ii3q_business",
			"status": "W2ii3q_status",
			"summary": "W2ii3q_summary",
			"output": "W2ii3q_output",
			"message": "W2ii3q_message",
			"title": "W2ii3q_title",
			"icon": "W2ii3q_icon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".UXGgHa_card{flex-direction:column;display:flex}.UXGgHa_card .UXGgHa_title,.UXGgHa_card .UXGgHa_chevron{color:var(--dsw-alias-state-business-primary)}.UXGgHa_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.UXGgHa_row{gap:0}.UXGgHa_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.UXGgHa_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.UXGgHa_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.UXGgHa_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.UXGgHa_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.UXGgHa_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.UXGgHa_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.UXGgHa_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.UXGgHa_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.UXGgHa_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.UXGgHa_switch{height:22px;padding:0 8px;font-size:12px}.UXGgHa_card[data-terminal] .UXGgHa_title,.UXGgHa_card[data-terminal] .UXGgHa_name,.UXGgHa_card[data-terminal] .UXGgHa_purpose,.UXGgHa_card[data-terminal] .UXGgHa_statusLabel{color:var(--dsw-alias-label-caption)}.UXGgHa_card[data-terminal] .UXGgHa_separator{background:var(--dsw-alias-label-caption)}.UXGgHa_bodyWrap{flex-direction:column;display:flex}.UXGgHa_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.UXGgHa_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.UXGgHa_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.UXGgHa_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.UXGgHa_sourceTab:disabled{cursor:default;opacity:.4}.UXGgHa_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.UXGgHa_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.UXGgHa_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.UXGgHa_sourcePanel{max-height:260px;overflow:auto}.UXGgHa_sourceCode{margin:0}.UXGgHa_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.UXGgHa_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.UXGgHa_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.UXGgHa_output[data-error]{color:var(--dsw-alias-state-error-primary)}.UXGgHa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.UXGgHa_card:hover .UXGgHa_inspectButton,.UXGgHa_inspectButton:focus-visible{opacity:1}.UXGgHa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.UXGgHa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.UXGgHa_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"sourceTabActive": "UXGgHa_sourceTabActive",
			"statusLabel": "UXGgHa_statusLabel",
			"sourceCode": "UXGgHa_sourceCode",
			"output": "UXGgHa_output",
			"name": "UXGgHa_name",
			"approvalPrompt": "UXGgHa_approvalPrompt",
			"panelHint": "UXGgHa_panelHint",
			"chevron": "UXGgHa_chevron",
			"switch": "UXGgHa_switch",
			"sourceCard": "UXGgHa_sourceCard",
			"sourceTabs": "UXGgHa_sourceTabs",
			"sourcePanel": "UXGgHa_sourcePanel",
			"readout": "UXGgHa_readout",
			"errorSummary": "UXGgHa_errorSummary",
			"codeSection": "UXGgHa_codeSection",
			"sectionLabel": "UXGgHa_sectionLabel",
			"visuallyHidden": "UXGgHa_visuallyHidden",
			"row": "UXGgHa_row",
			"inspectButton": "UXGgHa_inspectButton",
			"card": "UXGgHa_card",
			"title": "UXGgHa_title",
			"bodyWrap": "UXGgHa_bodyWrap",
			"purpose": "UXGgHa_purpose",
			"separator": "UXGgHa_separator",
			"sourceTab": "UXGgHa_sourceTab",
			"notice": "UXGgHa_notice",
			"requestError": "UXGgHa_requestError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".UmvZ5q_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.UmvZ5q_footerButtons{align-items:center;width:100%;display:flex}.UmvZ5q_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.UmvZ5q_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.UmvZ5q_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.UmvZ5q_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.UmvZ5q_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.UmvZ5q_layer.UmvZ5q_rail{width:36px;height:36px;margin:0}.UmvZ5q_rail .UmvZ5q_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.UmvZ5q_rail .UmvZ5q_footerButtons{flex-direction:column;gap:2px}.UmvZ5q_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.UmvZ5q_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.UmvZ5q_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.UmvZ5q_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.UmvZ5q_note,.UmvZ5q_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.UmvZ5q_readError{color:var(--dsw-alias-state-error-primary)}.UmvZ5q_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.UmvZ5q_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.UmvZ5q_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.UmvZ5q_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.UmvZ5q_rowHead{align-items:center;gap:8px;display:flex}.UmvZ5q_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.UmvZ5q_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.UmvZ5q_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.UmvZ5q_row[data-cordis-status=idle] .UmvZ5q_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.UmvZ5q_row[data-cordis-status=awaiting-approval] .UmvZ5q_rowStatus,.UmvZ5q_row[data-cordis-status=client-pending] .UmvZ5q_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.UmvZ5q_row[data-cordis-status=failed] .UmvZ5q_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.UmvZ5q_row[data-cordis-status=running] .UmvZ5q_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.UmvZ5q_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.UmvZ5q_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.UmvZ5q_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.UmvZ5q_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.UmvZ5q_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.UmvZ5q_rowActions{flex:none;align-items:center;gap:10px;display:flex}.UmvZ5q_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.UmvZ5q_transitionActions{gap:6px;margin-left:auto;display:flex}.UmvZ5q_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.UmvZ5q_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.UmvZ5q_transitionActions button:disabled{opacity:.4;cursor:default}.UmvZ5q_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.UmvZ5q_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.UmvZ5q_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.UmvZ5q_actionButton:disabled{opacity:.4;cursor:default}.UmvZ5q_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.UmvZ5q_doubleCheck svg{position:absolute;top:1px}.UmvZ5q_doubleCheck svg:first-child{opacity:.7;left:0}.UmvZ5q_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"doubleCheck": "UmvZ5q_doubleCheck",
			"rail": "UmvZ5q_rail",
			"badgeCount": "UmvZ5q_badgeCount",
			"header": "UmvZ5q_header",
			"rowStatus": "UmvZ5q_rowStatus",
			"transitionActions": "UmvZ5q_transitionActions",
			"activeVersion": "UmvZ5q_activeVersion",
			"panel": "UmvZ5q_panel",
			"body": "UmvZ5q_body",
			"title": "UmvZ5q_title",
			"badge": "UmvZ5q_badge",
			"rowId": "UmvZ5q_rowId",
			"rowActions": "UmvZ5q_rowActions",
			"rowHead": "UmvZ5q_rowHead",
			"rowName": "UmvZ5q_rowName",
			"versionPicker": "UmvZ5q_versionPicker",
			"layer": "UmvZ5q_layer",
			"rows": "UmvZ5q_rows",
			"note": "UmvZ5q_note",
			"readError": "UmvZ5q_readError",
			"transition": "UmvZ5q_transition",
			"row": "UmvZ5q_row",
			"badgeLabel": "UmvZ5q_badgeLabel",
			"rowPurpose": "UmvZ5q_rowPurpose",
			"group": "UmvZ5q_group",
			"footerButtons": "UmvZ5q_footerButtons",
			"rowDetail": "UmvZ5q_rowDetail",
			"actionButton": "UmvZ5q_actionButton",
			"rowError": "UmvZ5q_rowError"
		};
		//#endregion
