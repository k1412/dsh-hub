window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".NR4uPG_root{min-width:0;position:relative}.NR4uPG_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.NR4uPG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.NR4uPG_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.NR4uPG_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.NR4uPG_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.NR4uPG_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.NR4uPG_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.NR4uPG_chevronOpen{transform:rotate(180deg)}.NR4uPG_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.NR4uPG_status,.NR4uPG_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.NR4uPG_error,.NR4uPG_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.NR4uPG_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.NR4uPG_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.NR4uPG_groups{min-height:0;overflow-y:auto}.NR4uPG_group+.NR4uPG_group{margin-top:4px}.NR4uPG_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.NR4uPG_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.NR4uPG_option:hover:not(:disabled),.NR4uPG_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.NR4uPG_selected{background:0 0}.NR4uPG_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.NR4uPG_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.NR4uPG_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.NR4uPG_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.NR4uPG_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.NR4uPG_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.NR4uPG_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.NR4uPG_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.NR4uPG_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.NR4uPG_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"triggerEffort": "NR4uPG_triggerEffort",
			"error": "NR4uPG_error",
			"groups": "NR4uPG_groups",
			"triggerLabel": "NR4uPG_triggerLabel",
			"menu": "NR4uPG_menu",
			"selected": "NR4uPG_selected",
			"chevronOpen": "NR4uPG_chevronOpen",
			"cellLabel": "NR4uPG_cellLabel",
			"cellValue": "NR4uPG_cellValue",
			"cellChevron": "NR4uPG_cellChevron",
			"modelName": "NR4uPG_modelName",
			"trigger": "NR4uPG_trigger",
			"optionCopy": "NR4uPG_optionCopy",
			"root": "NR4uPG_root",
			"cell": "NR4uPG_cell",
			"empty": "NR4uPG_empty",
			"option": "NR4uPG_option",
			"status": "NR4uPG_status",
			"retry": "NR4uPG_retry",
			"group": "NR4uPG_group",
			"check": "NR4uPG_check",
			"groupTitle": "NR4uPG_groupTitle",
			"description": "NR4uPG_description",
			"warning": "NR4uPG_warning",
			"chevron": "NR4uPG_chevron"
		};
		//#endregion
