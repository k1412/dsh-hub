window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".WIn5iq_dialog.WIn5iq_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.WIn5iq_editorScope{display:contents}.WIn5iq_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.WIn5iq_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.WIn5iq_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.WIn5iq_crumbBar:has(.WIn5iq_crumbEditZone:enabled:hover),.WIn5iq_crumbBar:has(.WIn5iq_crumbEditZone:focus-visible),.WIn5iq_crumbBar:has(.WIn5iq_pathInput){border-color:var(--dsw-alias-border-l2)}.WIn5iq_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.WIn5iq_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.WIn5iq_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.WIn5iq_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.WIn5iq_crumb:hover{color:var(--dsw-alias-label-primary)}.WIn5iq_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.WIn5iq_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.WIn5iq_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.WIn5iq_crumbEditZone:enabled:hover .WIn5iq_crumbEditGlyph,.WIn5iq_crumbEditZone:focus-visible .WIn5iq_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.WIn5iq_crumbEditZone:disabled{cursor:default}.WIn5iq_crumbEditZone:disabled .WIn5iq_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.WIn5iq_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.WIn5iq_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.WIn5iq_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.WIn5iq_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.WIn5iq_rowSeat{flex:none;display:flex}.WIn5iq_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.WIn5iq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.WIn5iq_rowSelected,.WIn5iq_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.WIn5iq_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.WIn5iq_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.WIn5iq_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.WIn5iq_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.WIn5iq_status,.WIn5iq_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.WIn5iq_status{color:var(--dsw-alias-label-secondary)}.WIn5iq_error{color:var(--dsw-alias-state-error-primary)}.WIn5iq_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.WIn5iq_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.WIn5iq_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.WIn5iq_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.WIn5iq_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.WIn5iq_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.WIn5iq_footerGap{flex:1 1 0}.WIn5iq_footerAction{min-width:72px}.WIn5iq_createDialog.WIn5iq_createDialog{gap:0;width:min(380px,100%);padding:0}.WIn5iq_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.WIn5iq_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.WIn5iq_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.WIn5iq_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.WIn5iq_createInput::placeholder{color:var(--dsw-alias-label-caption)}.WIn5iq_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"rowIconSelected": "WIn5iq_rowIconSelected",
			"header": "WIn5iq_header",
			"dialog": "WIn5iq_dialog",
			"rowName": "WIn5iq_rowName",
			"createDialog": "WIn5iq_createDialog",
			"millerRow": "WIn5iq_millerRow",
			"crumbEditGlyph": "WIn5iq_crumbEditGlyph",
			"createActions": "WIn5iq_createActions",
			"showHiddenToggleActive": "WIn5iq_showHiddenToggleActive",
			"error": "WIn5iq_error",
			"rowChevron": "WIn5iq_rowChevron",
			"createIn": "WIn5iq_createIn",
			"crumb": "WIn5iq_crumb",
			"divider": "WIn5iq_divider",
			"title": "WIn5iq_title",
			"row": "WIn5iq_row",
			"crumbEditZone": "WIn5iq_crumbEditZone",
			"createBody": "WIn5iq_createBody",
			"column": "WIn5iq_column",
			"rowSeat": "WIn5iq_rowSeat",
			"crumbSeat": "WIn5iq_crumbSeat",
			"status": "WIn5iq_status",
			"loadingFloat": "WIn5iq_loadingFloat",
			"footerGap": "WIn5iq_footerGap",
			"createTitle": "WIn5iq_createTitle",
			"rowSelected": "WIn5iq_rowSelected",
			"rowIcon": "WIn5iq_rowIcon",
			"crumbTrail": "WIn5iq_crumbTrail",
			"crumbBar": "WIn5iq_crumbBar",
			"editorScope": "WIn5iq_editorScope",
			"crumbChevron": "WIn5iq_crumbChevron",
			"showHiddenToggle": "WIn5iq_showHiddenToggle",
			"footerBar": "WIn5iq_footerBar",
			"footerAction": "WIn5iq_footerAction",
			"pathInput": "WIn5iq_pathInput",
			"createInput": "WIn5iq_createInput",
			"content": "WIn5iq_content"
		};
		//#endregion
