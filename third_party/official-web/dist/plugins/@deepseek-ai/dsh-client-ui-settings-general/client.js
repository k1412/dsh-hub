window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = "._0mxBvq_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}._0mxBvq_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._0mxBvq_trigger._0mxBvq_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}._0mxBvq_triggerLabel{white-space:nowrap;overflow:hidden}._0mxBvq_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._0mxBvq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}._0mxBvq_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}._0mxBvq_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}._0mxBvq_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}._0mxBvq_navList{flex-direction:column;gap:4px;display:flex}._0mxBvq_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}._0mxBvq_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}._0mxBvq_navCell._0mxBvq_active{background:var(--dsw-specific-sidebar-nav-item-active)}._0mxBvq_navIcon{flex:none}._0mxBvq_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._0mxBvq_content{flex-direction:column;flex:1;min-width:0;display:flex}._0mxBvq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}._0mxBvq_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}._0mxBvq_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}._0mxBvq_close:hover{background:var(--dsw-alias-interactive-bg-hover)}._0mxBvq_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}._0mxBvq_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (width<=640px){._0mxBvq_overlay{justify-content:stretch;align-items:stretch}._0mxBvq_panel{border-radius:0;flex-direction:column;width:100vw;max-width:none;height:100dvh}._0mxBvq_nav{width:100%;padding:max(16px, env(safe-area-inset-top)) 12px 8px;border-bottom:1px solid var(--dsw-alias-border-l2);gap:10px}._0mxBvq_navTitle{padding:0 4px}._0mxBvq_navList{scrollbar-width:none;flex-direction:row;gap:6px;overflow-x:auto}._0mxBvq_navCell{flex:none;height:36px;padding:7px 12px}._0mxBvq_content{min-height:0}._0mxBvq_header{height:44px;padding:8px 10px 6px 12px}._0mxBvq_options{padding:0 12px max(20px, env(safe-area-inset-bottom))}}";
		...
		var SettingsRoot_module_css_default = {
			"navIcon": "_0mxBvq_navIcon",
			"hiddenLabel": "_0mxBvq_hiddenLabel",
			"content": "_0mxBvq_content",
			"triggerLabel": "_0mxBvq_triggerLabel",
			"navList": "_0mxBvq_navList",
			"actions": "_0mxBvq_actions",
			"navLabel": "_0mxBvq_navLabel",
			"panel": "_0mxBvq_panel",
			"header": "_0mxBvq_header",
			"close": "_0mxBvq_close",
			"options": "_0mxBvq_options",
			"mask": "_0mxBvq_mask",
			"active": "_0mxBvq_active",
			"rail": "_0mxBvq_rail",
			"overlay": "_0mxBvq_overlay",
			"trigger": "_0mxBvq_trigger",
			"navTitle": "_0mxBvq_navTitle",
			"nav": "_0mxBvq_nav",
			"navCell": "_0mxBvq_navCell"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = ".CqZEna_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "CqZEna_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".F1pcvW_section{flex-direction:column;width:100%;display:flex}.F1pcvW_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "F1pcvW_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/wuyang/Code/deepcode/dsh-hub/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".M1bNPG_action{align-items:center;gap:8px;min-width:0;display:flex}.M1bNPG_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
